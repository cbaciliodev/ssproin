...
const pagesRoutes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'ficha', component: GestionFComponent, data: { title: 'Gestión de fichas', routes: [{ title: 'Gestión de fichas' }] } },
            /* { path: 'ficha', component: FichaComponent, resolve: { ficha: FichaResolver }, data: { title: 'Ficha de proyecto', routes: [{ title: 'Ficha de proyecto' }] } } */
        ]
    }
];
